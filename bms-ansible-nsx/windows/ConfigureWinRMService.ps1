...
# -----------------------------------------------------------
#
# This script checks the current WinRM configuration and makes
# the necessary changes to allow Client to connect, authenticate and
...
Write-VerboseLog "WinRM Service has been successfully configured."
